...
namespace MdxLib.Animator.Animatable
{
	internal sealed class CVector3 : CAnimatable<MdxLib.Primitives.CVector3>
	{
		...
		public override MdxLib.Primitives.CVector3 InterpolateNone(CTime Time, CAnimatorNode<MdxLib.Primitives.CVector3> Node1, CAnimatorNode<MdxLib.Primitives.CVector3> Node2)
		{
			return Node1.Value;
		}

		public override MdxLib.Primitives.CVector3 InterpolateLinear(CTime Time, CAnimatorNode<MdxLib.Primitives.CVector3> Node1, CAnimatorNode<MdxLib.Primitives.CVector3> Node2)
		{
		...
		public override MdxLib.Primitives.CVector3 InterpolateBezier(CTime Time, CAnimatorNode<MdxLib.Primitives.CVector3> Node1, CAnimatorNode<MdxLib.Primitives.CVector3> Node2)
		{
			float num = (float)(Time.Time - Node1.Time) / (float)(Node2.Time - Node1.Time);
			float num2 = num * num;
			float num3 = 1f - num;
		...
		public override MdxLib.Primitives.CVector3 InterpolateHermite(CTime Time, CAnimatorNode<MdxLib.Primitives.CVector3> Node1, CAnimatorNode<MdxLib.Primitives.CVector3> Node2)
		{
			float num = (float)(Time.Time - Node1.Time) / (float)(Node2.Time - Node1.Time);
			float num2 = num * num;
