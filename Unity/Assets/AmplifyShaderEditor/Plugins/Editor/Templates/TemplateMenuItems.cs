...
namespace AmplifyShaderEditor
{
	public class TemplateMenuItems
	{
		...
		[MenuItem( "Assets/Create/Amplify Shader/Legacy/Samples/DoublePassUnlitSetVertex", false, 85 )]
		public static void ApplyTemplateLegacySamplesDoublePassUnlitSetVertex()
		{
			AmplifyShaderEditorWindow.CreateConfirmationTemplateShader( "343ea85c09e3a44438164e1fa784ee39" );
		}
