Shader "Zeng/war3/MapCliffs"
{
    Properties
    {
        ...
        u_cliffTexturesArray("u_cliffTexturesArray", 2DArray) = "" {}
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            UNITY_DECLARE_TEX2DARRAY(u_cliffTexturesArray);


            StructuredBuffer<float> locationBuffer;
            StructuredBuffer<int> textureIndexBuff;
            ...
            v2f vert(appdata v, uint instanceID : SV_InstanceID)
            {
                ...
                float sizeScale = 1.0 / u_war3unitRate;
                ...
                float2 corner = floor((a_instancePosition.xy - float2(1.0, 0.0) - u_offset.xy) / 128.0);
                ...
                o.uv.z = textureIndexBuff[instanceID];
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                fixed4 col = UNITY_SAMPLE_TEX2DARRAY(u_cliffTexturesArray, float3(i.uv.xy, i.uv.z));
